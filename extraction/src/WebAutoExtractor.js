...
exports.default = function () {
  ...
  var parse = function parse(html, options) {
    ...
    return {
      ...
      jsonldFailed: (0, _jsonldParserFailed2.default)($html)
    };
  };
  return {
    parse: parse,
...
var _jsonldParserFailed = require('./parsers/failed-jsonld-parser');
var _jsonldParserFailed2 = _interopRequireDefault(_jsonldParserFailed);
